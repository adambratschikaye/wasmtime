    ...
    pub fn link_and_append_code<'a>(
        ...
        artifacts.modules = translations
            ...
            .map(|(module, mut translation)| {
                ...
                if let Some(max_always_allowed) = memory_guaranteed_dense_image_size {
